...
public class ShippingRateController {
	...
	public String saveRate(ShippingRate rate, RedirectAttributes ra) {
		try {
			...
			return "redirect:/shipping_rates/page/1?sortField=id&sortDir=asc&keyword=" + rate.getId();
	...
	public String updateCODSupport(@PathVariable(name = "id") Integer id,
		...
		try {
			...
			return "redirect:/shipping_rates/page/1?sortField=id&sortDir=asc&keyword=" + id;
